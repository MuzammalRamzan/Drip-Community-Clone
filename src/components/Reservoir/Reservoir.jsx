          ...
          <div className="landing-page">
            <div className="row mb-4 mt-2">
              ...
              <div className="container col-xl-6 col-lg-6 col-md-6 mb-4 pt-4">
                ...
                <p className="col-12 white mb-3 text-justify fst-italic">
                  {" "}
                  {t(
                    "ReservoirisTheDRIPNetwork’ssolutionforplayersthatwantbenefitfromnon-inflationaryyieldfarmingthroughaddingliquiditytoDRIP.1"
                  )}
                </p>
            ...
            <div className="row mb-4 mt-2">
              <div className="container col-10 text-center">
                ...
                <p>
                  {t(
                    "ReservoirisTheDRIPNetwork’ssolutionforplayersthatwantbenefitfromnoninflationaryyieldfarmingthroughaddingliquiditytoDRIP.Herearethenumbers.1"
                  )}
                  ...
                </p>
              </div>
